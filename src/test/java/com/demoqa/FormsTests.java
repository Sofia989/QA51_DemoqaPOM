...
public class FormsTests extends TestBase {
    ...
    public void createStudentAccountTest() {
        practiceForm.enterPersonalData("Mara", "Fischer", "fischer@gmail.com", "1234567890")
                .selectGender("Female")
                .typeOfDate("16 May 1991")
                .addSubjects(new String[]{"Maths", "Chemistry"})
                .selectHobby(new String[]{"Music", "Reading"})
                .uploadFile("C:/Tools/stick2.jpg.jpg")
                .inputState("NCR")
                .inputCity("Delhi")
               .submitForm()
